...
enum L10n {
    enum Auth {
        ...
        /// Введите e-mail
        static let emailError = L10n.tr("Localizable", "auth.emailError", fallback: "Введите e-mail")
        /// Пароль
        static let password = L10n.tr("Localizable", "auth.password", fallback: "Пароль")
        /// Пароль должен содержать как минимум 6 символов
        static let passwordError = L10n.tr("Localizable", "auth.passwordError", fallback: "Пароль должен содержать как минимум 6 символов")
        /// Еще нет аккаунта?
    ...
    enum Register {
        ...
        /// Введите e-mail
        static let emailError = L10n.tr("Localizable", "register.emailError", fallback: "Введите e-mail")
        /// Фамилия
        ...
        /// Пароль должен содержать как минимум 6 символов
        static let passwordError = L10n.tr(
            "Localizable",
            "register.passwordError",
            fallback: "Пароль должен содержать как минимум 6 символов"
        )
        /// Это поле должно быть заполнено
        static let requiredFieldError = L10n.tr("Localizable", "register.requiredFieldError", fallback: "Это поле должно быть заполнено")
        /// Регистрация
